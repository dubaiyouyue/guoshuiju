...
if($action=="del"){
	...
	$query = "delete from $gz_online where id='$val'";
	$db->query($query);
	}
	...
	$query = "delete from $gz_online where id='$id'";
	$db->query($query);
	file_unlink($depth."../../cache/online_$lang.inc.php");
	metsave($rurl,'',$depth);
}
