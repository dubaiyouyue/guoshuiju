	...
	if($filenames){
		include "../../include/pclzip.lib.php";
		 ...
		 while(file_exists('../../databack/'.$filenames.$filenum.'.sql')){
			$sqlfiles[]='../../databack/sql/'.$gz_agents_backup.'_'.$filenames.$filenum.'.zip';
			if(!file_exists('../../databack/sql/'.$gz_agents_backup.'_'.$filenames.$filenum.'.zip')){
					if(!file_exists('../../databack/sql'))@mkdir ('../../databack/sql', 0777);  
					$sqlzip='../../databack/sql/'.$gz_agents_backup.'_'.$filenames.$filenum.'.zip';
