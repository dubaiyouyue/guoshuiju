...
$class1_info=$db->get_one("select * from $gz_column where lang='$lang' and id='$class1'");
...
$query = "SELECT * FROM $gz_job $serch_sql order by top_ok desc,no_order desc,addtime desc LIMIT $from_record, $list_num";
