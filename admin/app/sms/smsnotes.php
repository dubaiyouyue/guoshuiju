...
if($search == "detail_search") {			
	...
	$total_count = $db->counter($gz_sms, "$serch_sql", "*");
} else {
	$total_count = $db->counter($gz_sms, "$serch_sql", "*");
}
...
$query = "SELECT * FROM $gz_sms $serch_sql order by time desc LIMIT $from_record, $list_num";
