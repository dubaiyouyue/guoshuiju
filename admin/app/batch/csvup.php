...
if($static){
	...
	$query="select id from $gz_column where (classtype=1 or releclass!=0) and foldername='$classcsv[foldername]'";
...
if($classcsv['module']!=2){
	$querypara = "select * from $gz_parameter where lang='$lang' and module='$classcsv[module]' and (class1='0' or (class1='$class1' and class2='$class2' and class3=0) or (class1='$class1' and class2='$class2' and class3='$class3') or (class1='$class1' and class2=0 and class3=0)) order by no_order";
...
foreach($querycsvpara as $key2=>$val2){
    $query = "INSERT INTO $gz_plist SET listid ='$id',$val2";
    $db->query($query);
}
}
if($numcsv){
