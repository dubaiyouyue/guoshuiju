...
$classcsv=$db->get_one("select * from $gz_column where id='$class'");
$class1title=$db->get_one("select * from $gz_column where id='$class1'");
if($class2){$class2title=$db->get_one("select * from $gz_column where id='$class2'");}
if($class3){$class3title=$db->get_one("select * from $gz_column where id='$class3'");}
...
if($classcsv['module']!=2){
	$query = "select * from $gz_parameter where lang='$lang' and module='$classcsv[module]' and (class1='0' or (class1='$class1' and class2='$class2' and class3=0) or (class1='$class1' and class2='$class2' and class3='$class3') or (class1='$class1' and class2=0 and class3=0)) order by no_order";
