...
$classimg=$db->get_one("select * from $gz_column where id='$class'");
$class1title=$db->get_one("select * from $gz_column where id='$class1'");
$classtitle=$class1title['name'];
if($class2){$class2title=$db->get_one("select * from $gz_column where id='$class2'");$classtitle.="->$class2title[name]";}
if($class3){$class3title=$db->get_one("select * from $gz_column where id='$class3'");$classtitle.="->$class3title[name]";}
