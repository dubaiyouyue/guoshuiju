...
$query="select * from {$gz_visit_detail} WHERE stattime>='{$st}' and stattime<='{$et}' and type='1' and name!='' order by pv desc";
...
$query="select * from {$gz_visit_detail} WHERE stattime>='{$st}' and stattime<='{$et}' and type='1' order by pv desc";
$result= $db->query($query);
