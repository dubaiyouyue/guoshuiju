...
function methtml_product($listtype,$type,$titlenum,$paranum,$detail,$feedback,$time,$hits,$newwindow=1,$desription,$desnum,$classname,$news,$hot,$top,$listnav=1,$max,$topcolor){
 ...
 global $product_paralist,$gz_img_x,$gz_img_y,$addfeedback_url,$gz_product_page;
 ...
 $metproductok=0;
 if($gz_product_page && $listtype=='img' &&($search<>'search')){
...
if($listtype=='img'){
 ...
 if($metproductok){
 $listtext.=" ".$val[new_windows]."><img src=".$val[columnimg]." alt='".$val[name]."' title='".$val[name]."' width='".$gz_img_x."' height='".$gz_img_y."' /></a></span>";
 ...
 $listtext.=" ><img src=".$val[imgurls]." alt='".$val[title]."' title='".$val[title]."' width='".$gz_img_x."' height='".$gz_img_y."' /></a></span>";
...
function methtml_showproduct($type,$feedback=1,$desription){
 ...
 global $productpara,$product_paralist,$gz_img_x,$gz_img_y,$addfeedback_url,$gz_url,$product_paraimg;
