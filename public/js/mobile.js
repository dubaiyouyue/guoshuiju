...
function metinfo_mobile_prefix(){
	...
	mobile_prefix+='gz_mobileok=1';
	if(mobile_prefix.indexOf('lang=')==-1)mobile_prefix+='&lang='+mobile_lang;
	return mobile_prefix;
}
var hrefValue = window.location.href;
if(window.browser.mobile&&gz_wap_tpa==1){
	if(gz_wap_tpb==1&&gz_wap_url!=''&&String(hrefValue).indexOf(gz_wap_url)==-1){
...
if(gz_wap_tpb==1){
	if(gz_wap_url!=''&&String(hrefValue).indexOf(gz_wap_url)!=-1){
		window.location.href = metinfo_mobile_prefix();
	}
}