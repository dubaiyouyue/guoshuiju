...
class webset extends admin {
	...
	function doseteditor(){
		...
		$_M['form']['gz_foottelqq'] = $_M['form']['gz_foottelqq']+0;
		$_M['form']['gz_footteldianhua'] = $_M['form']['gz_footteldianhua']+0;
		$_M['form']['gz_headTeless'] = $_M['form']['gz_headTeless']+0;
		...
		$configlist[] = 'gz_ewmdhttt';
		$configlist[] = 'gz_ewmdhddbbttt';
		$configlist[] = 'gz_ewmdsxxqhddbbttt';
		$configlist[] = 'gz_zxcesdtup';
		$configlist[] = 'gz_xxyyzxddbbttt';
		$configlist[] = 'gz_ewmwwzzbbttt';
		$configlist[] = 'gz_ewmdzzfgttt';
		...
		$configlist[] = 'gz_foottelqq';
		$configlist[] = 'gz_footteldianhua2lyy';
		$configlist[] = 'gz_ewm';
		$configlist[] = 'gz_ewmdh';
		$configlist[] = 'gz_essyyzddmdh';
		$configlist[] = 'gz_essyyzmdh';
		$configlist[] = 'gz_essyddyyydyzmdh';
		$configlist[] = 'gz_ewmdhzbtp';
		$configlist[] = 'gz_headFaxess';
		$configlist[] = 'gz_fozzyhldianhua2';
