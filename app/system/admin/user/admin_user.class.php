...
class admin_user extends admin {
	...
	public function doaddsave(){
		...
		if($this->userclass->register($_M['form']['xm'], md5($_M['form']['password']),'','',$info, $_M['form']['tel'],$_M['form']['bm'],'', $_M['form']['jihuo'])){
	...
	public function doeditorsave(){
		...
		$sdfsdfsd=$this->userclass->editor_uesr($_M['form']['id'], $_M['form']['email'],$_M['form']['tel'], $_M['form']['valid'],$_M['form']['groupid'],$_M['form']['xm'],$_M['form']['password'], $_M['form']['jihuo']);
