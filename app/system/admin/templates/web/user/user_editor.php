	...
	<div class="v52fmbx">
		...
		<dl>
			...
			<dd class="ftype_input">
				<div class="fbox">
					<input type="text" name="xm" value="{$user['xm']}" />
				</div>
		...
		<h3 class="v52fmbx_hr" style="display:none;">账号安全</h3>
		<dl>
			<dt>密码重置</dt>
			<dd class="ftype_input">
				<div class="fbox">
...
function emailfunc(my,id,type){
	...
	return t;
		...
		<h3 class="v52fmbx_hr" style="display:none;">账号状态</h3>
		<dl style="display:none;">
			<dt>用户组</dt>
...
-->
		...
		<dl>
			...
			<dd class="ftype_select">
				<div class="fbox">
					<select name="jihuo" data-checked="{$user['jihuo']}">
		...
		<h3 class="v52fmbx_hr" style="display:none;">会员属性</h3>
<!--
EOT;
