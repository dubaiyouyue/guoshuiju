    ...
    <div class="v52fmbx">
		...
		<dl>
			...
			<dd class="ftype_input">
				...
				<!--<span class="tips">为空则系统自动构成</span>--><!--，可以到 营销-SEO 中设置构成规则。-->
			</dd>
		</dl>
		
		<h3 class="v52fmbx_hr">详细内容 <a href="http://newtest.test2.resonance.net.cn/helpueditor/php/upload/image/20180420/1524212294929056.png" target="_blank">插入视频教程</a></h3>
		<dl>
		...
		<dl>
			...
			<dd class="ftype_input">
				...
				<div class="fbox">
					<input type="text" name="scientific" value="{$list[scientific]}" class="">
				</div>
		...
		<dl>
			...
			<dd class="ftype_textarea">
				<div class="fbox">
					<textarea name="dezxcsption">{$list[dezxcsption]}</textarea>
				</div>
				<span class="tips">每行一个答案选项，第一行为正确答案，系统会自动乱序</span>
			</dd>
		</dl>
		...
		<!--<dl>
			...
			<dd class="ftype_input">
				...
				<div class="fbox">
					<input type="text" name="exhibitiontime" value="" class="">
				</div>
		...
		<dl>
			...
			<dd class="ftype_input">
				...
				<div class="fbox">
					<input type="text" name="exhibitionnum" style="width:100px;" value="" class="">
				</div>
		...
		<!--<dl>
			...
			<dd class="ftype_input">
				...
				<div class="fbox">
					<input type="text" name="exhibitionurl" value="" class="">
				</div>
...
<!--
EOT;
echo '--><dl style="display:none;"><dt>行业</dt><dd class="ftype_checkbox ftype_transverse"><div class="form-inline" style="margin-bottom:10px;"><div class="radio">';
$hhyy=explode("\r\n",$_M['config']['gz_headeryjhhyy']);
echo '<label><input name="gz_headeryjhhyy" type="radio"  data-checked="'.($list['gz_headeryjhhyy']).'" value="0">无</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
foreach($hhyy as $k=>$v){
	echo '<label><input name="gz_headeryjhhyy" type="radio"  data-checked="'.($list['gz_headeryjhhyy']).'" value="'.($k+1).'">'.$v.'</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
}
echo '</div></div></dd></dl><!--';
echo <<<EOT
-->	
...
-->			
				<div class="fbox">
					<input type="text" name="tvlinks"  value="{$list[tvlinks]}" />
				</div>
				<span class="tips">当前存在一个视频链接 名称为：《{$list[title]}》 编辑直接输入 如：iframe src=....</span>
<!--
EOT;
}else{
echo <<<EOT
-->	
				...
				<span class="tips">请输入要链接到的视频地址包含标签 如：iframe src=....</span>
<!--
EOT;
}
echo <<<EOT
...
-->
	...
	<div class="gz_affix_save bg-success">
