...
class ServiceAction extends BaseAction
{
    public function index()
    {
        ...
        $blist=$this->bannerlists(445);
		$getinfolamu=$this->get_column_info(445);$this->assign('getinfolamu',$getinfolamu);
		
         $tu=$this->bannerlist(200);
         $lanmu=M('column')->where('bigclass=445')->order('no_order asc,id asc')->select();
