...
class HeartAction extends BaseAction
{
    public function index()
    {
		...
		$getinfolamu=$this->get_column_info(406);$this->assign('getinfolamu',$getinfolamu);
		
		$cclslss='class2';
		if($cid==406) $cclslss='class1';
		   $lanmu=M('column')->where('bigclass=406')->order('no_order asc,id asc')->select();
