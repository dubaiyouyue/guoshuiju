...
$gz_langok[$val['mark']]['wapurl']="index.php?lang=$val[mark]";
if($metwaphtm=='metwaphtm')$gz_langok[$val['mark']]['wapurl']="index$val[mark].html";
if($metwaphtm=='metwaphtm' && $gz_index_type==$val[mark])$gz_langok[$val['mark']]['wapurl']="index.html";
}
$wapindex_url="index.php?lang=$lang";
if($metwaphtm=='metwaphtm'){
$wapindex_url="index{$lang}.html";
if($gz_index_type==$lang)$wapindex_url="index.html";
}
	...
	$qtext = $gz_wap_ok?"and wap_ok='1'":'';
	$query="select * from $gz_column where lang='$lang' $qtext order by no_order";
