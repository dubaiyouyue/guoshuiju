...
if(!$id){
	...
	$modulename = $db->get_one("select * from $gz_column where lang='$lang' and id = '$classwap'");
	...
	$modulename = $db->get_one("select * from $gz_column where lang='$lang' and id = '$classnow'");
